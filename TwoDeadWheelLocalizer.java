...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1161.6187153968501; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -0.5630965294566799; // x position of the perpendicular encoder (in tick units)
    }
